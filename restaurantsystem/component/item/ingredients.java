...
public class ingredients extends javax.swing.JFrame {
    ...
    private void performFileRelatedTask() {
        ...
        ingredientService.getAll().forEach((items) -> {
            fullnames.append(items.getName())
                    .append("\t")
        ...
        text1.setText(ingredientService.getPrice());
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Quantity Remaining");

        jLabel5.setBackground(new java.awt.Color(0, 153, 153));
        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setText("Ingredients Required");
        ...
        text1.getAccessibleContext().setAccessibleParent(text1);

        jLabel6.setText("Purchase Request Bill");
